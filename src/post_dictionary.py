...
def process_directory(input_dir, dictionary_file, posting_file):
    ...
    with open(dictionary_file, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        writer.writerow(["Token", "Cantidad de documentos que lo contienen", "Posicion del primer registro en posting"])
    ...
    print(f"Procesados {files_processed} archivos. Diccionario generado en {dictionary_file}. Archivo posting generado en {posting_file}.")

parser = argparse.ArgumentParser(description="Procesa archivos y cuenta palabras únicas por archivo.")
